        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white w-[70%] max-w-4xl p-6 rounded-lg h-[55vh]">
                <form onSubmit={handleSubmit} className="h-full flex flex-col">
                    ...
                    <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-6 overflow-auto">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    max="100"
                                    step="1"
                                    className="block w-full md:w-24 rounded-md border border-gray-300 px-4 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500"
                                    placeholder="1"
                                />
                            </div>
